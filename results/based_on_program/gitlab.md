...
| 3 | [Arbitrary file read  via the bulk imports UploadsPipeline](https://hackerone.com/reports/1439593) | $29000.0 |
| 4 | [RepositoryPipeline allows importing of local git repos](https://hackerone.com/reports/1685822) | $22300.0 |
| 5 | [Arbitrary file read via the UploadsRewriter when moving and issue](https://hackerone.com/reports/827052) | $20000.0 |
| 6 | [RCE via unsafe inline Kramdown options when rendering certain Wiki pages](https://hackerone.com/reports/1125425) | $20000.0 |
| 7 | [RCE when removing metadata with ExifTool](https://hackerone.com/reports/1154542) | $20000.0 |
| 8 | [Private objects exposed through project import](https://hackerone.com/reports/767770) | $20000.0 |
| 9 | [Steal private objects of other projects via project import](https://hackerone.com/reports/743953) | $20000.0 |
| 10 | [Arbitrary file read during project import](https://hackerone.com/reports/1132378) | $16000.0 |
| 11 | [Stored XSS in markdown via the DesignReferenceFilter ](https://hackerone.com/reports/1212067) | $16000.0 |
| 12 | [Stored XSS in Notes (with CSP bypass for gitlab.com)](https://hackerone.com/reports/1481207) | $13950.0 |
| 13 | [XSS in ZenTao integration affecting self hosted instances without strict CSP](https://hackerone.com/reports/1542510) | $13950.0 |
| 14 | [New /add_contacts /remove_contacts quick commands susseptible to XSS from Customer Contact firstname/lastname fields](https://hackerone.com/reports/1578400) | $13950.0 |
| 15 | [Stored XSS via Kroki diagram](https://hackerone.com/reports/1731349) | $13950.0 |
| 16 | [Bypass of GitLab CI runner slash fix in YAML validation](https://hackerone.com/reports/409395) | $12000.0 |
| 17 | [JSON serialization of any Project model results in all Runner tokens being exposed through Quick Actions](https://hackerone.com/reports/509924) | $12000.0 |
| 18 | [Local files could be overwritten in GitLab, leading to remote command execution](https://hackerone.com/reports/587854) | $12000.0 |
| 19 | [Project Template functionality can be used to copy private project data, such as repository, confidential issues, snippets, and merge requests](https://hackerone.com/reports/689314) | $12000.0 |
| 20 | [Git flag injection - local file overwrite to remote code execution](https://hackerone.com/reports/658013) | $12000.0 |
| 21 | [Path traversal in Nuget Package Registry](https://hackerone.com/reports/822262) | $12000.0 |
| 22 | [Path traversal, to RCE](https://hackerone.com/reports/733072) | $12000.0 |
| 23 | [Exfiltrate and mutate repository and project data through injected templated service](https://hackerone.com/reports/446585) | $11000.0 |
| 24 | [SSRF on project import via the remote_attachment_url on a Note](https://hackerone.com/reports/826361) | $10000.0 |
| 25 | [gitlab-workhorse bypass in Gitlab::Middleware::Multipart allowing files in `allowed_paths` to be read](https://hackerone.com/reports/850447) | $10000.0 |
| 26 | [Arbitrary POST request as victim user from HTML injection in Jupyter notebooks](https://hackerone.com/reports/1409788) | $8690.0 |
| 27 | [Content injection in Jira issue title enabling sending arbitrary POST request as victim](https://hackerone.com/reports/1533976) | $8690.0 |
| 28 | [DOS via issue preview](https://hackerone.com/reports/1543718) | $7640.0 |
| 29 | [Git flag injection - Search API with scope 'blobs' ](https://hackerone.com/reports/682442) | $7000.0 |
| 30 | [Stored XSS in markdown when redacting references](https://hackerone.com/reports/836649) | $5000.0 |
| 31 | [Persistent XSS in Note objects](https://hackerone.com/reports/508184) | $4500.0 |
| 32 | [Unauthenticated blind SSRF in OAuth Jira authorization controller](https://hackerone.com/reports/398799) | $4000.0 |
| 33 | [SafeParamsHelper::safe_params is not so safe](https://hackerone.com/reports/946728) | $4000.0 |
| 34 | [information disclosure of secret_key_base via encoding charcters](https://hackerone.com/reports/460545) | $3500.0 |
| 35 | [Cross-site Scripting (XSS) - Stored in RDoc wiki pages](https://hackerone.com/reports/662287) | $3500.0 |
| 36 | [Git flag injection leading to file overwrite and potential remote code execution](https://hackerone.com/reports/653125) | $3500.0 |
...
| 73 | [Attacker can create malicious child epics linked to a victim's epic in an unrelated group](https://hackerone.com/reports/1892200) | $1160.0 |
...
| 110 | [State filter in IssuableFinder allows attacker to delete all issues and merge requests](https://hackerone.com/reports/186194) | $0.0 |
...
| 147 | [Potensial SSRF via Git repository URL ](https://hackerone.com/reports/359288) | $0.0 |
...
| 184 | [Unrestricted file upload leads to Stored XSS](https://hackerone.com/reports/880099) | $0.0 |
...
| 221 | [Sending Arbitrary Requests through Jupyter Notebooks on gitlab.com and Self-Hosted GitLab Instances](https://hackerone.com/reports/970869) | $0.0 |
